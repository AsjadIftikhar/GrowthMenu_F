...
<React.Fragment>
      <div className="flex justify-between">
        ...
        <div className='flex flex-col justify-between '>
            ...
            <div className='text-sm text_Grey_3'>Feature description goes here Feature description goes here Feature description goes here </div>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='w-24'>
          <Button buttonText={"View Order"} backgroundColor="bg-white" textColor={"text-DarkBlue"} borderRadius="rounded-xl"/>
          </div>
