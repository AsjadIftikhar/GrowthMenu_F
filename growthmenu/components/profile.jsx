                ...
                <div className="basis-3/4 px-16 ">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-2 gap-16">
                            ...
                            <div className="mb-6 w-full">
                                <label className="block mb-2 text-sm text-gray-900">Business Category</label>

                                <Dropdown value={business_category}
                                          data={CATEGORY_CHOICES}
                                          placeholder={"Select Category"}
                                          styleClass={"bg-gray-50 border border-gray-300 text-gray-900 text-sm " +
