...
const ServiceDescription = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const response = await get_service_description(router.query.id)
    ...
    return (
        <div>
            ...
            <div className="mb-4 w-4/5 bg-gray-50 rounded-lg">
                ...
                {/*    <ul>*/}
                {/*        <li>Full-fledged custom website development in Django<br/></li>*/}
                {/*        <li>Fix backend and frontend bugs<br/></li>*/}
                {/*        <li>Deploy web application on server<br/></li>*/}
                {/*        <li>Third-Party API Integration<br/></li>*/}
                {/*        <li>RESTful API development<br/></li>*/}
                {/*        <li>E-Commerce websites from scratch<br/></li>*/}
                {/*    </ul>*/}
                {/*    Proper indentation and commenting<br/><br/>*/}
                {/*    Now, you do not need to spend hundreds of dollar for a script, when you can get it for a few bucks.<br/>*/}
