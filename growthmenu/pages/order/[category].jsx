...
//         <>
//             <div
//                 className="p-4 w-full text-2xl bg-DarkBlue font-bold text-gray-900 dark:text-white text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
//                 Submit Your Requirements to Start Your Order
//             </div>
//             <div
...
const Premium = () => {
    ...
    return (
        <React.Fragment>
            <div className="text-2xl font-semibold py-5">Premium Package</div>
