...
const Service = () => {
    ...
    return (
        ...
        <React.Fragment>
            <div className="bg-LightGrey p-8 flex">
                <div>
                    <SideBar/>
                </div>
            ...
            <div
                className="py-4 px-4 md:px-16 bg-gradient-to-r from-DarkBlue via-LightBlue to-LightYellow md:flex md:items-center md:justify-between">
                    <span className="text-gray-300 sm:text-center">© 2022
                        <Link href="https://flowbite.com"> GrowthMenu™</Link>. All Rights Reserved.
                    </span>
